...
const navItems = [
  { path: "/arabic", label: "الرئيسية", icon: Home, exact: true },
  { path: "/arabic/mafahim", label: "المفاهيم", icon: BookOpen },
  { path: "/arabic/quiz", label: "اختبارات", icon: HelpCircle },
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            <Link to="/arabic" className="flex items-center gap-2 no-underline">
              <span className="text-xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">فهم</span>
              <span className="text-[10px] font-medium text-gray-400 dark:text-neutral-500 bg-gray-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded">العربية</span>
            </Link>
          </div>
          <div className="flex items-center gap-1">
            ...
            <button onClick={() => setDark(!dark)} className="p-2 rounded-lg text-gray-400 dark:text-neutral-500 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors cursor-pointer bg-transparent border-0">
