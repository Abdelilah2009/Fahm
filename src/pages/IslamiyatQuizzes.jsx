...
export default function IslamiyatQuizzes() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
      <div className="mb-10">
        <h1 className="text-3xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">اختبارات الإسلاميات</h1>
        <p className="mt-2 text-gray-500 dark:text-neutral-400">اختبر معلوماتك في التربية الإسلامية</p>
      </div>
      <div className="grid sm:grid-cols-2 gap-4">
        {islamiyatQuizzes.map((quiz) => (
          <Link key={quiz.id} to={`/islamiyat/quiz/${quiz.id}`} className="group p-6 rounded-xl border border-gray-200 dark:border-neutral-800 no-underline hover:border-gray-300 dark:hover:border-neutral-700 transition-colors">
